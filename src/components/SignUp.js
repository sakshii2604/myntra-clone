          ...
          <form onSubmit={setupAcc}>
            <div>
              ...
              <div className="row gx-0">
                <div className="col-lg-3 col-md-3 col-sm-6 col-12 mt-2">
                  <div className="px-3 align-items-center d-flex justify-content-center" style={passwordCriteriaStyle}>
                    8 Characters
                  </div>
                </div>
              ...
              <div className="d-flex my-3" style={{ color: "grey" }}>
                ...
                <div className="ml-auto d-flex">
                  ...
                  <label>Female</label>
                  <input type="radio" name="btn" className="form-check mr-2 ml-4" />
                  <label>Male</label>
                </div>
              </div>
            ...
            <div>
              <input
                ...
                style={{ height: "40px" }}
              />
              <label className="mb-2" style={{ color: "#A9ABB3", fontSize: "14px" }}>
